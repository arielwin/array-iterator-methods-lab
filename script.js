...
sortedByBirthYear = inventors.sort(function(year1, year2){
...
// 4. Use Array.prototype.find() to identify the inventor with the first 
//name 'Ada' from an array of inventor objects
...
// 8. Use Array.prototype.find() to identify and retrieve the comment object 
// with a specific ID 823423 from an array of comment objects.
...
// - Each object in the array includes properties: 'first', 'last', 'year' (birth year), and 
// 'passed' (year of death).
...
// - The resulting object should have keys as the travel methods ('car', 'truck', 'bike', etc.) 
